...
Braxton Thomas";
            ...
            migrationBuilder.InsertData(table: "Genries",
                columns: new string[] { "Id", "Name", "DateTimeAdd", "DateTimeChange", "Version" },
                values: new object[] { 1, "horror", DateTime.Now, DateTime.Now, 1 });

            migrationBuilder.InsertData(table: "Genries",
                columns: new string[] { "Id", "Name", "DateTimeAdd", "DateTimeChange", "Version" },
                values: new object[] { 2, "Sci-Fi", DateTime.Now, DateTime.Now, 1 });

            migrationBuilder.InsertData(table: "Genries",
                columns: new string[] { "Id", "Name", "DateTimeAdd", "DateTimeChange", "Version" },
                values: new object[] { 3, "drama", DateTime.Now, DateTime.Now, 1 });

            for (int i = 0; i < listBirhtday.Length; i++)
            {
                var fio = listFIO[i].Split(" ");
                migrationBuilder.InsertData(table: "Peoples",
                    columns: new string[] { "Id", "Name", "LastName", "MidleName", "Birthday", "DateTimeAdd", "DateTimeChange", "Version" },
                    values: new object[] { i + 1, fio[0], fio[1], fio[2], DateTime.Parse(listBirhtday[i]), DateTime.Now, DateTime.Now, 1 });
            }
            ...
            {
                var genryRnd = rnd.NextDouble();

                migrationBuilder.InsertData(table: "Authors",
                    columns: new string[] { "Id", "Name", "LastName", "DateTimeAdd", "DateTimeChange", "Version" },
                    values: new object[] { i + 1, authors[i].Split(" ")[0], authors[i].Split(" ")[1], DateTime.Now, DateTime.Now, 1 });

                migrationBuilder.InsertData(table: "Books",
                    columns: new string[] { "Id", "Title", "AuthorId", "PeopleModelId", "DateTimeAdd", "DateTimeChange", "Version" },
                    values: new object[] { i + 1, nameBook[i], i + 1, i + 1, DateTime.Now, DateTime.Now, 1 });

                migrationBuilder.InsertData(table: "BookModelGenryModel",
                    columns: new string[] { "BooksId", "GenreId" },
                    values: new object[] { i + 1, genryRnd < 0.3 ? 1 : genryRnd < 0.67 ? 2 : 3 });
            }
        }
